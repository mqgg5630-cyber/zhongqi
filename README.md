...
- **机制补充页**（H 版第 19—24 页 / 中间版第 11—14 页，`code/make_ppt_mech.py`）：七环逻辑链、炎症—Aβ—抗菌肽正反馈、AChE–Aβ 动力学、交叉成核、八问作答表、文献一览表。
- **新增流程页（第 5 页）与分组页（第 6 页）**：宏基因组流程用原生可编辑方框 + 箭头；分组页写清 5 阶段 × 2 性别 × 3 年龄段的匹配方式。H 版共 24 页，中间版共 14 页。
