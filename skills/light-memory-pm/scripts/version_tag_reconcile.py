...
# -*- coding: utf-8 -*-
"""
version_tag_reconcile.py —— version_history 与 git tag 对齐核对 (Light v2 / light-memory-pm)

落地 SKILL.md/README 反复强调却零执行的纪律：「论文/PPT/代码出新版→追加
version_history 并打 `git tag -a`，二者必须对齐」。本脚本解析项目 .light/ 的
...
def selftest():
    ...
    tmp = tempfile.mkdtemp(prefix="vtr_selftest_", dir=_e2e_selftest_dir())
    rc = 1
    try:
